...
class RecyclerTab2(var context: Context) : RecyclerView.Adapter<RecyclerTab2.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            image = itemView.findViewById(R.id.image_tab2)
            title = itemView.findViewById(R.id.title_tab2)
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.tab2_item, parent, false)
