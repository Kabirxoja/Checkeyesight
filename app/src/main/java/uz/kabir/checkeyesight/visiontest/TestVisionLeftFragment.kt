...
class TestVisionLeftFragment : Fragment() {

    private var _binding: FragmentFirstVisionTestBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFirstVisionTestBinding.inflate(inflater, container, false)
        return binding.root
    }
