...
class TestVisionRightFragment : Fragment() {

    private var _binding: FragmentRightVisionTestBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRightVisionTestBinding.inflate(inflater, container, false)
        return binding.root
    }
